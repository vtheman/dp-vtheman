...
%whiteboard is offerd in a form of Skype extra for money - uSeeToo, talkandwrite - basic versino free - 10 min limit, 1 to 1, WhiteBoardMeeting, Sketch Pad - free


%brosix, voice 
%text messaging, offline text messaging, voice and video chat, co-browsing - browsing websites on shared view of screen, co-browse session
%whiteboard - MS-Paint like,screen sharing even with using his or her mouse and keyboard.

%Wndows Live Messenger 
% - only windows
% additional application, only two users
